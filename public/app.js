const vm = new Vue ({
    ...
    data () {
      return {
        baseUrl: 'https://3000-neonalphakp-elasticsear-0p5usn83wxn.ws-eu95.gitpod.io', // API url
    ...
    methods: {
      ...
      async prevBookPage () {
        this.$refs.bookModal.scrollTop = 0
        ofst=this.bookOffset - 10
        if(ofst<0) ofst=0
        this.paragraphs = await this.getParagraphs(this.selectedParagraph._source.title, ofst)
      },
